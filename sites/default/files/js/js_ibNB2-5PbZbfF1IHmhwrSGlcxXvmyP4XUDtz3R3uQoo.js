	...
	if ($(document).innerWidth() > 940){
		$('.main-menu li').each(function (index, element){
			if ($(this).children('div').length > 0){
				...
				if(cnt< 10 ){
					$(this).find('div').addClass('col-1');
				   }else if(cnt> 10 && cnt< 6){
					 $(this).find('div').addClass('col-2');  
				   }else if(cnt>17){
					 $(this).find('div').addClass('col-2');  
				   }
			}
        ...
        if ($(document).innerWidth() > 940) {
            ...
            $('#main_menu .nav-menu .nav-item').each(function (index, element){
                ...
                if (m > (t - 100)) {
                    ...
                    $(this).parent().append('<li class="btn-more-li"><a class="btn-more" title="'+ Drupal.t('More') + '" id="btn-more-toggle" href="javascript:void(0)">' + Drupal.t('More') + '</a></li>');
                    $(this).remove();
...
var modulePath = '/modules/cmf/cmf_design';
